package kotiki.security;

import kotiki.security.dto.JwtResponse;
import kotiki.security.dto.LoginRequest;
import kotiki.security.dto.MessageResponse;
import kotiki.security.dto.SignupRequest;
...
import kotiki.security.repository.RoleRepository;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser( @RequestBody SignupRequest signUpRequest) {
        ...
        ownerService.create(user.getId());
